...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QRect(1250, 20, 211, 368))
        ...
        self.txtbuscarcli = QLineEdit(self.verticalLayoutWidget)
        self.txtbuscarcli.setObjectName(u"txtbuscarcli")

        self.verticalLayout_5.addWidget(self.txtbuscarcli)
        ...
        self.txtnombrecli.setReadOnly(True)

        self.verticalLayout_6.addWidget(self.txtnombrecli)
        ...
        self.txtrtnclien = QLineEdit(self.verticalLayoutWidget)
        self.txtrtnclien.setObjectName(u"txtrtnclien")
        self.txtrtnclien.setReadOnly(True)

        self.verticalLayout_10.addWidget(self.txtrtnclien)
        ...
        self.txtdireccioncli = QLineEdit(self.verticalLayoutWidget)
        self.txtdireccioncli.setObjectName(u"txtdireccioncli")
        self.txtdireccioncli.setReadOnly(True)

        self.verticalLayout_11.addWidget(self.txtdireccioncli)
        ...
        self.txttelefonocli = QLineEdit(self.verticalLayoutWidget)
        self.txttelefonocli.setObjectName(u"txttelefonocli")
        self.txttelefonocli.setReadOnly(True)

        self.verticalLayout_8.addWidget(self.txttelefonocli)
        ...
        self.txtemailcli = QLineEdit(self.verticalLayoutWidget)
        self.txtemailcli.setObjectName(u"txtemailcli")
        self.txtemailcli.setReadOnly(True)

        self.verticalLayout_9.addWidget(self.txtemailcli)
        ...
        self.gridLayoutWidget_2.setGeometry(QRect(30, 130, 591, 31))
        ...
        self.horizontalLayoutWidget.setGeometry(QRect(30, 200, 361, 31))
        ...
        self.listaclientes = QTableView(self.centralwidget)
        self.listaclientes.setObjectName(u"listaclientes")
        self.listaclientes.setGeometry(QRect(760, 40, 381, 192))
        self.listaclientes.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.label_19 = QLabel(self.centralwidget)
        self.label_19.setObjectName(u"label_19")
        self.label_19.setGeometry(QRect(910, 20, 111, 20))
        self.label_19.setFont(font1)
        self.label_20 = QLabel(self.centralwidget)
        self.label_20.setObjectName(u"label_20")
        self.label_20.setGeometry(QRect(230, 250, 231, 20))
        self.label_20.setFont(font)
        self.listaproductosinv = QTableView(self.centralwidget)
        self.listaproductosinv.setObjectName(u"listaproductosinv")
        self.listaproductosinv.setGeometry(QRect(30, 280, 1111, 192))
        self.label_21 = QLabel(self.centralwidget)
        self.label_21.setObjectName(u"label_21")
        self.label_21.setGeometry(QRect(230, 480, 231, 20))
        self.label_21.setFont(font)
        self.listaproductosfac = QTableView(self.centralwidget)
        self.listaproductosfac.setObjectName(u"listaproductosfac")
        self.listaproductosfac.setGeometry(QRect(30, 510, 1111, 192))
        self.gridLayoutWidget_3 = QWidget(self.centralwidget)
        self.gridLayoutWidget_3.setObjectName(u"gridLayoutWidget_3")
        self.gridLayoutWidget_3.setGeometry(QRect(1170, 410, 296, 92))
        ...
        self.gridLayoutWidget_4.setGeometry(QRect(1170, 520, 301, 141))
        ...
        self.verticalLayoutWidget_2.setGeometry(QRect(1170, 670, 160, 41))
        self.verticalLayout_2 = QVBoxLayout(self.verticalLayoutWidget_2)
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.btnvender = QPushButton(self.verticalLayoutWidget_2)
        self.btnvender.setObjectName(u"btnvender")
        self.btnvender.setFont(font1)
        ...
        self.btnagregar.setGeometry(QRect(420, 200, 158, 26))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Ventas", None))
        self.label.setText("")
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Ventas de Productos", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Buscar Cliente", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Nombre de Cliente", None))
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"RTN Cliente", None))
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"Direccion Cliente", None))
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"Telefono Cliente", None))
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"Email Cliente", None))
        ...
        self.label_16.setText(QCoreApplication.translate("MainWindow", u"Precio L.", None))
        ...
        self.label_19.setText(QCoreApplication.translate("MainWindow", u"Lista Clientes", None))
        ...
        self.btnvender.setText(QCoreApplication.translate("MainWindow", u"Vender", None))
