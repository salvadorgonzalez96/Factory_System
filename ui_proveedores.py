...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tablaproveedores = QTableView(self.centralwidget)
        self.tablaproveedores.setObjectName(u"tablaproveedores")
        self.tablaproveedores.setGeometry(QRect(20, 50, 256, 421))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Menu proveedores", None))
        self.label.setText("")
